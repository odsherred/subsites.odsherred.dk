<?php
// $Id: agreservations-calendar-day-1.tpl.php,v 1.1.1.1.4.2 2010/09/18 18:10:49 agill Exp $

/**
 * @file
 * Template to display a view as a calendar day, grouped by time ----This is a copy from the original calendar to provide
 * normal non agreservations behavior when viewing normal calendars(name 1=bookingcalendar2)
...
?>
      ...
      <th class="calendar-agenda-items">
<?php
  print $column;
?>
</th>
